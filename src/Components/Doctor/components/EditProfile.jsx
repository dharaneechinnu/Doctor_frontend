...
const AddDoctorForm = () => {
  ...
  const fetchdoctor=async()=>{
    try {
        const response= await axios.get('https://doctor-backend-eubv.onrender.com/doctor-single',{
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     const response=  await axios.patch('https://doctor-backend-eubv.onrender.com/doctor-update', doctorData,{
        headers: {
